...
def run_photoshop_processing(files_list, contract_px):
    ...
    for file_path in files_list:
        ...
        jsx_code = JSX_PS_TEMPLATE \
            .replace("FILE_PATH", json.dumps(file_path_js)) \
            .replace("SAVE_PATH", json.dumps(temp_final_path_js)) \
            .replace("STATUS_PATH", json.dumps(status_path_js)) \
